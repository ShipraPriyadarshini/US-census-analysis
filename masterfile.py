...
xtemp00 = ["Population_00","White_00","Black_00","Asian_00","Hispanic_00","Republican_00",
           "Democratic_00","Independence_00","Conservative_00","Liberal_00","Green_00","Working_Families_00",
           "AvgHousePrice_00"]

xtemp10 = ["Population_10","White_10","Black_10","Asian_10","Hispanic_10","Democratic_10","Republican_10",
...
for nn in  xtemp00:
    ...
    logger.info("intercept:",intercepts)
    logger.info("slope:", slopes)
    
    new_model = LinearRegression().fit(x, y.reshape((-1, 1)))
    #print("intercept:", new_model.intercept_)
    #print("slope:", new_model.coef_)
    slopes = new_model.coef_
    intercepts = new_model.intercept_
    logger.info("intercept:",intercepts)
    logger.info("slope:",slopes)
